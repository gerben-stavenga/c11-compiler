# 1 "/home/priv-gerben/project/gazelle/c11/tests/gcc-src/gcc/testsuite/gcc.c-torture/execute/conversion.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/priv-gerben/project/gazelle/c11/tests/gcc-src/gcc/testsuite/gcc.c-torture/execute/conversion.c" 2
# 11 "/home/priv-gerben/project/gazelle/c11/tests/gcc-src/gcc/testsuite/gcc.c-torture/execute/conversion.c"
void abort (void);
void exit (int);
...
test_longlong_integer_to_float()
{
  ...
  if (ull2d(0ULL) != (double) 0ULL)
    abort();
# 200 "/home/priv-gerben/project/gazelle/c11/tests/gcc-src/gcc/testsuite/gcc.c-torture/execute/conversion.c"
  if (ull2d(~0ULL) != (double) ~0ULL)
    abort();
